...
public class LibraryTest {
	...
	Book book2 = new Book("EM", 1002, "돈 설명서", "라슈미 시데르슈판드", "솔빛길", false, "327.04");
	Book book3 = new Book("EM", 1003, "완전한 행복", "정유정", "은행나무", true, "813.7-정67ㅇ2");
	...
	// Book 삭제
	bookarraylist.removeBook(book1.getBookNumber());
	bookarraylist.showAllBook();
